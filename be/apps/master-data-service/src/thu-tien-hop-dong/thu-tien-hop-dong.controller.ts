...
@Controller('thu-tien-hop-dong')
@UseGuards(JwtGuard, RoleGuard)
export class ThuTienHopDongController {
  constructor(private readonly service: ThuTienHopDongService) {}
  ...
  @Post()
  @Roles(...WRITE)
  async create(@Body() dto: CreateThuTienHopDongDto) {
  ...
  @Put(':id')
  @Roles(...WRITE)
  async update(@Param('id') id: string, @Body() dto: UpdateThuTienHopDongDto) {
