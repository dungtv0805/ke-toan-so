...
export function UploadStep() {
  ...
  return (
    <Space direction="vertical" style={{ width: "100%" }} size="middle">
      ...
      <Text type="secondary">
        Mỗi dòng = 1 chứng từ. Cột Ngày và Số tiền bắt buộc. Chọn giá trị từ danh sách thả xuống trong từng cột danh mục (có thể gõ tay mã nếu muốn). File còn lỗi sẽ không import được.
      </Text>
    </Space>
  );
}
