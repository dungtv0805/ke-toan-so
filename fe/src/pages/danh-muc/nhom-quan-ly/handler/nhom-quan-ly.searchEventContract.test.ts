...
// Nhóm quản lý dựa vào (dispatch "search" với keyword rỗng thay vì "refresh" -
// vốn đọc lại filter cũ đã lưu trong state).
//
// File này KHÔNG render/thực thi component trang (NhomQuanLyPage...): repo
...
describe("NhomQuanLyHandler - hợp đồng của sự kiện \"search\" (nền tảng cho fix Task 12 ở trang)", () => {
  beforeEach(() => {
