...
export const KhoaSoPage = loadable(() => import('./tong-hop/khoa-so/KhoaSoPage'), {
  fallback: <PageLoader />
});
...
export const PnlKhongKhauHaoPage = loadable(
  () => import('./bao-cao/pnl-khong-khau-hao/PnlKhongKhauHaoPage'),
  {
  fallback: <PageLoader />
  },
);
